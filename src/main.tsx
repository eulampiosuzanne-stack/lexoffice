...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><BrowserRouter>{isPublicIntake?<PublicClientForm token={intakeToken}/>:<OfficeBrandBridge><><RootApp/><ClientFormShareAction/><ClientMessageActionBridge/><ThemeController/></></OfficeBrandBridge>}</BrowserRouter></React.StrictMode>);
