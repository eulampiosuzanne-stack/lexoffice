...
const isPublicPlans=['/planos','/precos','/pricing'].includes(window.location.pathname.replace(/\/$/,''));
...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><BrowserRouter>{isPublicIntake?<PublicClientForm token={intakeToken}/>:isPublicPlans?<Planos/>:<OfficeBrandBridge><><RootApp/><ClientFormShareAction/><ClientMessageActionBridge/><BulkClientMessageBridge/><ThemeController/></></OfficeBrandBridge>}</BrowserRouter></React.StrictMode>);
