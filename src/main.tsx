...
import CalculatorPdfAutofillBridge from './components/CalculatorPdfAutofillBridge';
...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><BrowserRouter>{isPublicIntake?<PublicClientForm token={intakeToken}/>:isPublicLanding?<Landing/>:isPublicPlans?<Planos/>:isPublicCheckout?<Checkout/>:<OfficeBrandBridge><><RootApp/><ClientFormShareAction/><ClientMessageActionBridge/><BulkClientMessageBridge/><CalculatorPdfAutofillBridge/><ThemeController/></></OfficeBrandBridge>}</BrowserRouter></React.StrictMode>);
