...
ReactDOM.createRoot(document.getElementById('root')!).render(<React.StrictMode><BrowserRouter>{isPublicIntake?<PublicClientForm token={intakeToken}/>:isPublicLanding?<Landing/>:isPublicPlans?<Planos/>:<OfficeBrandBridge><><RootApp/><ClientFormShareAction/><ClientMessageActionBridge/><BulkClientMessageBridge/><ThemeController/></></OfficeBrandBridge>}</BrowserRouter></React.StrictMode>);
